...
export function TestimonialCard({ quote, name, role, company, avatarSrc }: TestimonialItem) {
  return (
    <div className="flex aspect-[4/5] w-full flex-col gap-4 rounded-2xl border border-[#E8E8E8] bg-white p-6 shadow-md transition-all duration-[250ms] ease-out hover:-translate-y-1 hover:shadow-lg sm:p-8">
